...
class Vector:
    ...
    def __rmul__(self, s):
        ...
        Vector([3.0, 6.0, 9.0])
        """
        return Vector([s * self._coords[i] for i in range(len(self._coords))])
    ...
    def __mul__(self, s):
        ...
        Vector([3.0, 6.0, 9.0])
        """
        return Vector([self._coords[i] * s for i in range(len(self._coords))])
    ...
    def __neg__(self):
        ...
        Vector([-1.0, 2.0, -3.0])
        """
        return Vector([-1.0 * c for c in self._coords])
    ...
    def mag(self):
        ...
        3.7416573867739413
        """
        return sqrt(sum([c ** 2 for c in self._coords]))
    ...
    def normalize(self):
        ...
        """
        ax, ay, az = self._coords
        self._coords = [ax/self.mag(), ay/self.mag(), az/self.mag()]
    ...
    def normalized(self):
        ...
        """
        ax, ay, az = self._coords
        return Vector([ax/self.mag(), ay/self.mag(), az/self.mag()])
